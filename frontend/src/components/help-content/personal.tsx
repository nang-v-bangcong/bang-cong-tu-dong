    ...
    <>
      ...
      <section>
        ...
        <ul>
          ...
          <li><b>Sửa tên:</b> icon bút chì cạnh tên để đổi tên bản thân.</li>
      ...
      <section>
        ...
        <dl>
          ...
          <dd>Là công ở công trường chưa nhập đơn giá (hoặc ô chưa gán công trường). Vẫn tính vào tổng công nhưng không cộng vào lương.</dd>
