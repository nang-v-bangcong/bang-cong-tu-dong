...
export function BulkUpsertCells(arg1:Array<services.CellUpsert>):Promise<void>;
...
export function GetTeamMonthSummaries(arg1:string):Promise<Array<models.UserMonthSummary>>;
